...
def Canada_figure(input,fld,varName,tCentral,output, imgout, matrice_col=None, reverse_col=None, txtLabel=None,clevs=None):
    ...
    data0 = nc.variables[varName][:,:,0].squeeze()
...
input= 'G:/30. CLIMATE SERVICES DATA PRODUCTS OFFICE/05 - Personal/Lee/'
...
varName='heat_wave_max_length_Tmin20_Tmax30_p10'
