...
input= 'G:/30. CLIMATE SERVICES DATA PRODUCTS OFFICE/03 - Data, Code & Models/02 - Code/python/trainingData/tas_hist_gfdlcm3.nc'
# Put in output the path and the name of the file you want to create
output='G:/30. CLIMATE SERVICES DATA PRODUCTS OFFICE/03 - Data, Code & Models/02 - Code/python/trainingOutput/test_annual_mean_degroot.nc'
...
dataT=annual_mean_3D(input, show_newPer='NO', save_nerCDF='NO')

# I will use the following line if I want to save the new file as netCDF 
annual_mean_3D(input, show_newPer='NO', save_nerCDF=output)
