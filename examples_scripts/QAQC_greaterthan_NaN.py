# -*- coding: utf-8 -*-
"""
Created on Tue Feb  5 12:56:14 2019
...
def QAQC_GT(file, var, latitude, longitude, save_nerCDF='NO',save_CSV='NO'):
    ...
    threshold = put here the maximum value of climate variable
...
#put here maximum threshold for climate variable 
threshold=45
...
for fld in list[:]:
    ...
    dataS = QAQC_GT(input + fld, var, latitude, longitude, save_nerCDF=output+new_netCDF, save_CSV=output+new_csv)
