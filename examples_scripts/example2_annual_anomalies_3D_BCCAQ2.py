...
#####################################
def annual_anomalies_3D(file, first_year, last_year, project, rcp, varName,units,show_newPer='YES', save_nerCDF='NO'):
    ...
    ref_mean=ref_datashell_scripts
    ...
    annual_anomalies.attrs['experiment']=rcp
    annual_anomalies.attrs['GCM']=ds.attrs['driving_model_id']
...
###########################################
# Put in input the passway and the netCDF file you want

input='G:/30. CLIMATE SERVICES DATA PRODUCTS OFFICE/03 - Data, Code & Models/02 - Code/python/trainingOutput/test_sel/'
output='G:/30. CLIMATE SERVICES DATA PRODUCTS OFFICE/03 - Data, Code & Models/02 - Code/python/trainingOutput/test_anom/'
...
for fld in list[:]:
    ...
    annual_anomalies_3D(input+fld,first_year, last_year, 'BCCAQ2', 'RCP2.6','pr','mm/day',show_newPer= 'NO', save_nerCDF=output+fileout)
