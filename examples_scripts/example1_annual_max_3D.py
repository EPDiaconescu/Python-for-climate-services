...
#####################################
def annual_max_3D(file, show_newPer='YES', save_nerCDF='NO'):
    """ This function will open an 3D netcDF file, compute the time maximum for each year and save the new 3D file in netCDF
...
output='G:/30. CLIMATE SERVICES DATA PRODUCTS OFFICE/03 - Data, Code & Models/02 - Code/python/trainingOutput/test_annual_max.nc'
...
dataT=annual_max_3D(input, show_newPer='YES', save_nerCDF='NO')

# I will use the following line if I want to save the new file as netCDF 
annual_max_3D(input, show_newPer='YES', save_nerCDF=output)
