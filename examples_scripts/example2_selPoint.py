...
input='H:/30. CLIMATE SERVICES DATA PRODUCTS OFFICE/05 - Personal/Lee/Nain/Downscaled projections/Nain_modifications/'

# Put in output the path to the folder where you want to save the files
output='H:/30. CLIMATE SERVICES DATA PRODUCTS OFFICE/05 - Personal/Lee/Nain/Downscaled projections/Nain_modifications/'
